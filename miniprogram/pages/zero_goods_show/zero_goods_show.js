...
Page({
                ...
                wx.request({
                  ...
                  success: function (data) {
                    ...
                    that.setData({
                      ...
                      zero_list: data.data.data[0].zero_list,
  ...
  share: function(options) {
    ...
    if (wx_mini_reg_status != 3) {
      ...
      var share_data = {
        token: getApp().globalData.user.token,
        scene: v_scene,
        page: 'pages/zero_goods_show/zero_goods_show',
        user_id: user_id
      }
      wx.request({
  ...
  launch: function() {
    ...
    if (wx_mini_reg_status != 3) {
      ...
      wx.navigateTo({
        url: '../zero_choose_date/zero_choose_date'
      })
    }
  },
  // 返回首页
  ...
  onShareAppMessage: function (res) {
    ...
    if (res.from === 'button') { //我自定义的分享
      return {
        title: share_title,
        path: '/pages/zero_goods_show/zero_goods_show?share_btn=1' + '&user_id' + user_id + '&id=' + that.data.aaa,
      }
