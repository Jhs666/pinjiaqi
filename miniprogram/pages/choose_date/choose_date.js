...
Page({
  ...
  zhuanhuangeshi: function() {
    var dateTime = wx.getStorageSync('orderDetail')[0].trip_time_list;
    var newDateTime = {};
    var j = '';
    for (var i = 1; i < 13; i++) {
      j = i;
    ...
    for (var i in dateTime) {
      var arr = dateTime[i].trip_start_time.split('-');
      var month = arr[1];
      var obj = {};
      obj.day = arr[2];
      obj.price = dateTime[i].price;
      obj.piece_price = dateTime[i].piece_price;
      obj.child_price = dateTime[i].child_price;
      obj.child_piece_price = dateTime[i].child_piece_price;
      obj.id = dateTime[i].id;
  ...
  next_page: function() {
    ...
    // console.log(app.globalData.travel_human_type)
    // console.log(app.globalData.travel_child_human_type)
    // console.log(app.globalData.travel_total)
    // return
